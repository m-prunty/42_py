...
#    Updated: 2026/05/27 16:29:20 by maprunty        ###   ########.fr        #
#                                                                             #
# *************************************************************************** #
...
AlgoName = Literal["dfs", "prim", "swinder", "wilson", "kruskal"]
PathAlgoName = Literal["dijkstra"]
...
class Config(BaseModel):
    ...
    gen_algo: AlgoName = "dfs"
    path_algo: PathAlgoName = "dijkstra"
